...
/* classlist is used to check if a certain class is present or not */
...
function checkemail(email)
{
    ...
    else
    {
        ...
        document.getElementById('email_error').innerText = 'Email must include @gmail and atleast 8 letters long'
    }
}
